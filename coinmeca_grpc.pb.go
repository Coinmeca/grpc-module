...
type MarketInfo struct {
	...
	Asks      []*Tick       `protobuf:"bytes,8,rep,name=asks,proto3" json:"asks,omitempty"`
	Bids      []*Tick       `protobuf:"bytes,9,rep,name=bids,proto3" json:"bids,omitempty"`
...
func (x *MarketInfo) GetVolume() *MarketVolume {
	if x != nil {
		return x.Volume
	}
	return nil
...
func (x *MarketInfo) GetAsks() []*Tick {
	if x != nil {
		return x.Asks
	}
	return nil
...
func (x *MarketInfo) GetBids() []*Tick {
	if x != nil {
		return x.Bids
	}
	return nil
...
var file_coinmeca_grpc_proto_rawDesc = []byte{
	...
	0x36, 0x0a, 0x04, 0x54, 0x69, 0x63, 0x6b, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x12, 0x18, 0x0a,
	0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x22, 0x5d, 0x0a, 0x0f, 0x4d, 0x61, 0x72, 0x6b, 0x65,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x71, 0x75, 0x6f, 0x74, 0x65, 0x22, 0xf2, 0x02, 0x0a, 0x0a,
	...
	0x63, 0x6b, 0x12, 0x30, 0x0a, 0x06, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01,
	...
	0x6c, 0x75, 0x6d, 0x65, 0x12, 0x24, 0x0a, 0x04, 0x61, 0x73, 0x6b, 0x73, 0x18, 0x08, 0x20, 0x03,
	...
	0x64, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x6d,
	...
	0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64,
	...
	0x01, 0x52, 0x08, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x74,
...
var file_coinmeca_grpc_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_coinmeca_grpc_proto_goTypes = []interface{}{
	...
	(*MarketOrderbook)(nil),        // 19: grpcmodule.MarketOrderbook
	(*MarketOrderbookRequest)(nil), // 20: grpcmodule.MarketOrderbookRequest
	(*MarketVolume)(nil),           // 21: grpcmodule.MarketVolume
	(*MarketInfo)(nil),             // 22: grpcmodule.MarketInfo
	(*MarketRecentRequest)(nil),    // 23: grpcmodule.MarketRecentRequest
	(*MarketRecent)(nil),           // 24: grpcmodule.MarketRecent
	(*FarmRecentRequest)(nil),      // 25: grpcmodule.FarmRecentRequest
	(*FarmRecent)(nil),             // 26: grpcmodule.FarmRecent
	(*FarmRecentResponse)(nil),     // 27: grpcmodule.FarmRecentResponse
	(*FarmInfoRequest)(nil),        // 28: grpcmodule.FarmInfoRequest
	(*FarmInfo)(nil),               // 29: grpcmodule.FarmInfo
}
var file_coinmeca_grpc_proto_depIdxs = []int32{
	...
	23, // 4: grpcmodule.GeneralRequest.marketRecent:type_name -> grpcmodule.MarketRecentRequest
	...
	18, // 14: grpcmodule.MarketOrderbook.asks:type_name -> grpcmodule.Tick
	18, // 15: grpcmodule.MarketOrderbook.bids:type_name -> grpcmodule.Tick
	19, // 16: grpcmodule.MarketOrderbookRequest.data:type_name -> grpcmodule.MarketOrderbook
	21, // 17: grpcmodule.MarketInfo.volume:type_name -> grpcmodule.MarketVolume
	18, // 18: grpcmodule.MarketInfo.asks:type_name -> grpcmodule.Tick
	18, // 19: grpcmodule.MarketInfo.bids:type_name -> grpcmodule.Tick
	24, // 20: grpcmodule.MarketRecentRequest.data:type_name -> grpcmodule.MarketRecent
	1,  // 21: grpcmodule.MarketRecent.type:type_name -> grpcmodule.MarketTradeType
	26, // 22: grpcmodule.FarmRecentRequest.data:type_name -> grpcmodule.FarmRecent
	2,  // 23: grpcmodule.FarmRecent.type:type_name -> grpcmodule.FarmTradeType
	29, // 24: grpcmodule.FarmInfoRequest.data:type_name -> grpcmodule.FarmInfo
	3,  // 25: grpcmodule.CoinmecaGrpcModule.AddData:input_type -> grpcmodule.GeneralRequest
	4,  // 26: grpcmodule.CoinmecaGrpcModule.AddData:output_type -> grpcmodule.GeneralResponse
